...
export function SearchBar({ variant = 'home' }: SearchBarProps) {
    ...
    const handleSearch = () => {
        ...
        if (checkIn && checkOut) {
            ...
            datesToSend = [formatInputDate(new Date(checkIn)), formatInputDate(new Date(checkOut))];
        }
        ...
        const isHotelDetailPage = location.pathname.includes("/hotels/") && location.pathname.split("/").length > 2;
    ...
    const inputClassName = "w-full pl-11 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 placeholder:text-gray-400";
        ...
        `}>
            <div className={`grid gap-4 ${
                ...
                <div className="relative">
                    {variant === 'home' && <label className="block text-sm text-gray-600 mb-2">Destination</label>}
                    <div className="relative">
                ...
                {/* --- Input 2: Check-in --- */}
                <div className="relative">
                    {variant === 'home' && <label className="block text-sm text-gray-600 mb-2">Check-in</label>}
                    <div className="relative">
                ...
                {/* --- Input 3: Check-out --- */}
                <div className="relative">
                    {variant === 'home' && <label className="block text-sm text-gray-600 mb-2">Check-out</label>}
                    <div className="relative">
                        <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5 pointer-events-none" />
                        <input
                            type="date"
                ...
                {/* --- Input 4: Guests --- */}
                <div className="relative">
                    {variant === 'home' && <label className="block text-sm text-gray-600 mb-2">Guests</label>}
                    <div className="relative">
