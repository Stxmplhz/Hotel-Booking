...
const Header = ({ 
  ...
  const navBtnClass = "px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-blue-800 rounded-lg transition-colors";
  ...
  return (
    <nav className="flex items-center justify-between px-6 py-4 bg-white dark:bg-blue-950 shadow-sm sticky top-0 z-50 transition-colors duration-300">
      ...
      <div className="flex items-center gap-4">
        {isLoggedIn ? (
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 text-gray-700 dark:text-gray-200">
              <RiAccountCircleFill className="w-8 h-8 text-blue-600" />
        ...
        >
          {theme === "light" ? <MdSunny size={24}/> : <BsFillMoonStarsFill size={20}/>}
        </button>
      </div>
