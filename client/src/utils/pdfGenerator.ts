...
export const generateInvoicePDF = (booking: Booking) => {
  ...
  doc.text(`Invoice #: INV-${booking._id.substring(0, 8).toUpperCase()}`, 14, 28);
  ...
  doc.setFontSize(10);
  doc.setTextColor(0, 0, 0);
  doc.text(`${booking.guestDetails.firstName} ${booking.guestDetails.lastName}`, 14, 56);
  ...
  doc.text(`Guests: ${booking.guestCount.adults} Adults, ${booking.guestCount.children} Children`, 110, 66);
